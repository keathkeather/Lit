...
const PricingScreen: React.FC<PricingScreenProps> = () => {
  ...
  return (
    <div className="overflow-y-auto" style={{ paddingTop: '64px' }}>
      ...
      <header className="bg-white fixed top-0 left-0 right-0 z-20 p-2 md:p-4 flex flex-row lg:flex-row items-center justify-between">
      ...
      <section className="mt-16 flex justify-center items-center h-full relative z-10">
        <div className="flex flex-col lg:flex-row justify-center items-center">
          ...
          <div className="bg-white rounded-lg p-6 mx-4 my-4 mt-10 " style={{ height: '400px', width: '450px' }}>
            ...
            <div className="bg-bgc1 rounded-lg p-3 mx-1 my-1  items-center">
              ...
              <div className="mx-1 my-1 flex items-center p-3">
                ...
                <h6 className="text-white font-bold mb-0">Can’t buy perks on Shop</h6>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 mx-4 my-4 mt-10" style={{ height: '400px', width: '450px' }}>
            ...
            <div className="bg-bgc2 rounded-lg p-2 mx-1 my-1  items-center ">
              ...
              <div className="mx-1 my-1 flex items-center p-3">
                ...
                <h6 className="text-white font-bold mb-0">Can buy perks on Shop</h6>
              </div>
            </div>
          </div>
        </div>
